...
function normalizeRiderPartnerOrder(data: Json | null): RiderPartnerOrder | null {
  ...
  return {
    ...
    payment_confirmed_at: rawOrder.payment_confirmed_at ?? null,
    payment_confirmed_by: rawOrder.payment_confirmed_by ?? null,
    payment_method: rawOrder.payment_method ?? 'GCash',
    payment_notes: rawOrder.payment_notes ?? null,
    payment_proof_path: rawOrder.payment_proof_path ?? null,
    payment_proof_url: rawOrder.payment_proof_url ?? null,
    payment_reference: rawOrder.payment_reference ?? null,
    payment_status: rawOrder.payment_status ?? 'paid',
    payment_submitted_at: rawOrder.payment_submitted_at ?? null,
